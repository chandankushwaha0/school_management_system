...
<form class="px-5" action="">
    <label for="floatingTextarea">About Courses Heading: </label>
    <div class="form-floating">
        <textarea class="form-control" placeholder="Leave about Course Heading here" id="floatingTextarea"></textarea>
    </div>
